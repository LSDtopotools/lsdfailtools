...
gdf = gpd.read_file(shpdir + data_source+ "_" + "depth_csv_to_shapefile.shp")
gdf_fos = gpd.read_file(shpdir + data_source+ "_" +  "factor_of_safety_csv_to_shapefile.shp")
gdf_tof = gpd.read_file(shpdir + data_source+  "_" + "time_of_failurecsv_to_shapefile.shp")
