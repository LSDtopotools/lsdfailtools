...
for i in range(len(threshold)):
	...
	Aarr, pixelWidth, (geotransform, inDs) = fn.ENVI_raster_binary_to_2d_array(out_failure_dir+"A_failtime_1_threshold"+str(threshold[i])+"mmyr.bil")
	preAarr, pixelWidth, (geotransform, inDs) = fn.ENVI_raster_binary_to_2d_array(out_failure_dir+"A_prefailtime_1_threshold"+str(threshold[i])+"mmyr.bil")
	A_startdate = datetime.datetime(FILE_PATHS["asc_start_year"], FILE_PATHS["asc_start_month"], FILE_PATHS["asc_start_day"])

	Darr, pixelWidth, (geotransform, inDs) = fn.ENVI_raster_binary_to_2d_array(out_failure_dir+"D_failtime_1_threshold"+str(threshold[i])+"mmyr.bil")
	preDarr, pixelWidth, (geotransform, inDs) = fn.ENVI_raster_binary_to_2d_array(out_failure_dir+"D_prefailtime_1_threshold"+str(threshold[i])+"mmyr.bil")
	D_startdate = datetime.datetime(FILE_PATHS["desc_start_year"], FILE_PATHS["desc_start_month"], FILE_PATHS["desc_start_day"])

	EWVarr, pixelWidth, (geotransform, inDs) = fn.ENVI_raster_binary_to_2d_array(out_failure_dir+"EWV_failtime_1_threshold"+str(threshold[i])+"mmyr.bil")
	preEWVarr, pixelWidth, (geotransform, inDs) = fn.ENVI_raster_binary_to_2d_array(out_failure_dir+"EWV_prefailtime_1_threshold"+str(threshold[i])+"mmyr.bil")
	...
	# save the files
	fn.ENVI_raster_binary_from_2d_array( (geotransform, inDs), out_failure_dir+"All_1st_failtime__threshold"+str(threshold[i])+"mmyr.bil", pixelWidth, Combo_failarr)
	fn.ENVI_raster_binary_from_2d_array( (geotransform, inDs), out_failure_dir+"All_1st_prefailtime__threshold"+str(threshold[i])+"mmyr.bil", pixelWidth, Combo_prefailarr)
